    ...
    <div class="cms-main-wrapper">
        <div class="cms-form-container">
            ...
            <div class="cms-header-section">
                <h2>SEO Keyword Management</h2>
                <p>Manage your website's focus keywords and SEO meta data</p>
            </div>
            ...
            <div class="cms-card">
                <div class="cms-form-grid">
                    ...
                    <!-- Left Side: Keyword Details -->
                    <div class="cms-left-col">
                        <div class="cms-form-group">
                            <label>Focus Keyword Name</label>
                            <asp:TextBox ID="txtKeywordName" runat="server" CssClass="cms-input" placeholder="e.g. Best Web Development Services"></asp:TextBox>
                    ...
                    <!-- Right Side: Instructions or Metadata -->
                    <div class="cms-right-col">
                         <div class="cms-upload-box">
                            <p style="font-size: 13px; color: #718096; margin-bottom: 10px;">
                                <i class="fa fa-info-circle"></i> <strong>SEO Tip:</strong> <br />
                                Keywords should be relevant to your content. Avoid keyword stuffing. 
                                High-quality keywords help in ranking higher on Google searches.
                            </p>
                    ...
                    <div class="cms-actions">
                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="cms-btn cms-btn-secondary" OnClick="btnCancel_Click" />
                        <asp:Button ID="btnSave" runat="server" Text="Save Keyword" CssClass="cms-btn cms-btn-primary" 
                            ValidationGroup="seo" OnClick="btnSave_Click" />
                    </div>
                </div>
            </div>
            ...
            <div class="cms-card">
                ...
                <div class="cms-table-res">
                    <asp:GridView ID="gvKeywords" runat="server" AutoGenerateColumns="False" CssClass="cms-grid" 
                        DataKeyNames="KeywordID" OnRowCommand="gvKeywords_RowCommand" GridLines="None">
                        <Columns>
                            <asp:BoundField DataField="KeywordID" HeaderText="ID" ItemStyle-Width="50px" />
                            <asp:BoundField DataField="KeywordName" HeaderText="Keyword Name" />
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditRow" 
                                        CommandArgument='<%# Eval("KeywordID") %>' CssClass="cms-action-btn cms-edit">Edit</asp:LinkButton>
